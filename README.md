...
DarkCool is released under the [MIT License](LICENSE.md). Please review # DarkCool
...
DarkCool Tools is always updated all the time and will be reported on [Telegram](https://t.me/dymlescode) chan# DarkCool
...
the license terms before using or contributing to this project.
...
Enjoy using DarkCool and stay cool!
nel, I hope you join in to see news about DarkCool.
